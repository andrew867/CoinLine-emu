...
// Class C: cross-trace matrix per audio-call-state-integration — requires coinline-mame.exe + flash.bin + traces.
...
int main()
{
	...
	std::cout << "SKIP: Class C call-state cross-trace — run tools/windows/test-coinline-emulator.ps1 per docs/audio-ci-plan.md\n";
	return 77;
}
